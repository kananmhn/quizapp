...
export const DonutChart = ({ data, total, used, type, className }: DonutChartProps) => {
  ...
  let css_string = data
    ...
    .reduce((prev, current, currentIndex, array) => {
      const startPercentage = convertToPercentage(currentIndex === 0 ? 0 : array[currentIndex - 1].value);
